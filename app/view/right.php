	...
	*/
	...
	<script type="text/javascript">
		function UR_Start() {
			...
			document.getElementById("ur").innerHTML = "<?php echo date('d/m/Y') ?> - " + UR_Indhold + "hs";
			document.getElementById("urParent").attributes["title"].value = "Data/Hora ( " + "<?php echo date('d/m/Y') ?> - " + UR_Indhold + "hs )";
